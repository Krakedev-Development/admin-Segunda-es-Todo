...
export function ModalEdit({ item, visible, onCloseModal, name, pts, img, onEdit }) {
                ...
                <View style={styles.modalContent}>
                    ...
                    <View>
                        ...
                        <View style={{marginBottom: 10}}>
                            ...
                            <Button title="Editar" color={theme.colors.orangeSegunda} onPress={handleEdit} />

                        </View>

                        <Button title="Cancelar" color={theme.colors.redSegunda} onPress={onCloseModal} />
