...
export const RedeemCode = () => {
  ...
  const generatePDF = () => {
    ...
    const svgString = renderToStaticMarkup(<View>{qrCode}</View>);

    const html = `
    <!DOCTYPE html>
    <html>
    <head>
        <title>Documento PDF con código QR</title>
    </head>
    <body>
        ${svgString}
    </body>
          ...
          {generate && valueCode ? (
            ...
            >
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  setGenerate(true), generatePDF();
                }}
              >
                <StyledText color={"white"}>Generar nuevamente</StyledText>
              </TouchableOpacity>
            </View>
          ) : (
            <TouchableOpacity
            ...
            >
              <StyledText color={"white"}>Generar Código</StyledText>
            </TouchableOpacity>
          )}
        </View>
